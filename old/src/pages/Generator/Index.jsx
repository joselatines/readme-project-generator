	...
	return (
		<Container>
			<Helmet>
				...
				<meta
					name='title'
					content='README project generator — Preview, Edit and Generate'
				/>
				<meta
					name='description'
					content='The easiest way to create a README for your project. Our simple template creates you a README file base in your entries , add title, description, features, libraries, frameworks languages and much more.'
				/>
				<meta
					name='keywords'
					content='README, readme generator, markdown, markdown generator, free readme generator'
				/>
				<meta name='author' content='Jose Latines' />
				<link
					rel='canonical'
					href='https://readme-project-generator.netlify.app/'
				/>
			</Helmet>
			<FieldsContainer>
